#pragma once
#ifndef _GROUPPERSONMEMBER_VO_
#define _GROUPPERSONMEMBER_VO_

#include "../../GlobalInclude.h"
#include "../../dto/group/GroupNameDTO.h"
...
class GroupJsonVO : public JsonVO<GroupNameDTO::Wrapper> {
	DTO_INIT(GroupJsonVO, JsonVO<GroupNameDTO::Wrapper>);
};
