...
#include "../../../dto/get/GetGroupMembers/GetGroupMembersDTO.h"
...
//	}
//};
class GetGroupMembersJsonVO : public JsonVO<GetGroupMembersDTO::Wrapper> {
	DTO_INIT(GetGroupMembersJsonVO, JsonVO<GetGroupMembersDTO::Wrapper>);
};
/**
 * 分页显示JsonVO，用于响应给客户端的Json对象
 */
class GetGroupMembersPageJsonVO : public JsonVO<GetGroupMembersPageDTO::Wrapper> {
	DTO_INIT(GetGroupMembersPageJsonVO, JsonVO<GetGroupMembersPageDTO::Wrapper>);
};
