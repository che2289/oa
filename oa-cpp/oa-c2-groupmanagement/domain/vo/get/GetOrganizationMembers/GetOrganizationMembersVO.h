...
#include "../../../dto/get/GetOrganizationMembers/GetOrganizationMembersDTO.h"
...
//	}
//};
class GetOrganizationMembersJsonVO : public JsonVO<GetOrganizationMembersDTO::Wrapper> {
	DTO_INIT(GetOrganizationMembersJsonVO, JsonVO<GetOrganizationMembersDTO::Wrapper>);
};
/**
 * 分页显示JsonVO，用于响应给客户端的Json对象
 */
class GetOrganizationMembersPageJsonVO : public JsonVO<GetOrganizationMembersPageDTO::Wrapper> {
	DTO_INIT(GetOrganizationMembersPageJsonVO, JsonVO<GetOrganizationMembersPageDTO::Wrapper>);
};
