...
class GetGroupInfoVO : public oatpp::DTO
{
	...
	//创建时间
	API_DTO_FIELD(String, createTime, ZH_WORDS_GETTER("groupManagement.groupInfo.field.createTime"), false, "errorrrrrrrrrrr");
	//更新时间
	API_DTO_FIELD(String, updateTime, ZH_WORDS_GETTER("groupManagement.groupInfo.field.updateTime"), false, "errorrrrrrrrrrr");
