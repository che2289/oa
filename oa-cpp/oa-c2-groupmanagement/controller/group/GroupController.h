...
public:
	...
	// 3.2 定义修改接口处理
	API_HANDLER_ENDPOINT_AUTH(API_M_PUT, "/group", modifyGroup, BODY_DTO(Group_DTO::Wrapper, dto), executeModifyGroup(dto));
...
private:
	...
	UserPage_JsonVO::Wrapper executeQueryUser(const String& id);
};
